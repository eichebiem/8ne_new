...
?>
			...
			<div class="theme-inner-banner section-spacing">
				<div class="overlay">
					<div class="container">
						<h2>Payroll Management & Filing</h2>
					</div> <!-- /.container -->
				</div> <!-- /.overlay -->
					...
					<div class="row">
						<div class="col-xl-9 col-lg-8 col-12">
							<div class="service-content">
								...
								<h3 class="main-title">Payroll Management & Filing</h3>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-8 col-12 theme-sidebar-one">
							<div class="sidebar-box service-categories">
								...
								<ul>
									...
									<li class="active"><a href="payroll-management-filing.php">Payroll Management & Filing</a></li>

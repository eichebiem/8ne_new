					...
					<div class="row">
						<div class="col-xl-9 col-lg-8 col-12">
							<div class="service-content">
								...
								<h3 class="main-title">Microsoft Excel Training</h3>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-8 col-12 theme-sidebar-one">
							<div class="sidebar-box service-categories">
								...
								<ul>
									<li class="active"><a href="excel-training.php">Microsoft Excel Training</a></li>
									<li><a href="business-permits-processing.php">Business Permits Processing</a></li>
									<li><a href="bookkeeping-tax-filing.php">Bookkeeping & Tax Filing</a></li>
									<li><a href="payroll-management-filing.php">Payroll Management & Filing</a></li>
									<li><a href="statistical-analysis.php">Statistical Analysis</a></li>
								</ul>
							...
							<div class="sidebar-box sidebar-contact">
								<h5 class="title">Request for Quotation</h5>
								...
								<a href="https://form.jotform.me/80923774915466" target="_blank" rel="noopener noreferrer" class="theme-button-one">SUBMIT</a>
							</div> <!-- /.sidebar-contact -->
